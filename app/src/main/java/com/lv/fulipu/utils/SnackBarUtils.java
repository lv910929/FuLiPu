...
public class SnackBarUtils {
    ...
    public static Snackbar defaultSnackBar(View view, String message) {
        ...
        setSnackBarColor(snackbar, FuLiApplication.getInstance().getResources().getColor(R.color.white), FuLiApplication.getInstance().getResources().getColor(R.color.colorPrimary));
        return snackbar;
    }
